...
use std::os::hermit::prelude::OsStrExt;
#[cfg(unix)]
...
#[cfg(not(any(target_os = "hermit", target_os = "redox")))]
...
#[cfg(not(target_os = "hermit"))]
pub(crate) use libc::{
    IPV6_MULTICAST_HOPS, IPV6_MULTICAST_IF, IPV6_UNICAST_HOPS, IP_MULTICAST_IF, MSG_OOB, SO_TYPE,
};

pub(crate) use libc::{
    ip_mreq as IpMreq, linger, IPPROTO_IP, IPPROTO_IPV6, IPV6_MULTICAST_LOOP, IPV6_V6ONLY,
    IP_ADD_MEMBERSHIP, IP_DROP_MEMBERSHIP, IP_MULTICAST_LOOP, IP_MULTICAST_TTL, IP_TTL, MSG_PEEK,
    SOL_SOCKET, SO_BROADCAST, SO_ERROR, SO_KEEPALIVE, SO_RCVBUF, SO_RCVTIMEO, SO_REUSEADDR,
